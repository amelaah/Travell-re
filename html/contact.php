  ...
  <body>
    ...
    <div class="contact">
      ...
      <div class="contact-container">
        <div class="box">
          <div class="box-img">
            <img src="../images/contact.php" alt="phone" />
          </div>
          <div class="text">
            <h4>By Phone</h4>
            <p>
              Need help?<br />
              Click here for a quick phone call. <br />
              <a href="">+123456780</a>
            </p>
          </div>
        </div>
        ...
        <div class="box">
          <div class="box-img">
            <img src="../images/email.php" alt="email" />
          </div>
          <div class="text">
            <h4>By E-Mail</h4>
            <p>
              Do you have further questions? <br />
              Write us an e-mail about it. <br />
              <a href="">travelly@gmail.com</a>
            </p>
          </div>
        </div>
        ...
        <div class="box">
          <div class="box-img">
            <img src="../images/social.php" alt="socials" />
          </div>
          <div class="text">
            <h4>By Socials</h4>
            <p>
              Can't get enough of us? <br />
